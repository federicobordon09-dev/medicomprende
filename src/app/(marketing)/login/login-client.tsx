  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-warm-600 mb-6 leading-relaxed text-center">
        Accedé a tu cuenta de <strong>MediComprende</strong> para ver tus análisis guardados.
      </p>
      <button
      ...
      <p className="text-xs text-warm-400 text-center mt-4">
        ¿No tenés cuenta?{" "}
        <Link href="/register" className="text-xs text-warm-400 hover:text-warm-600 hover:underline">
          Registrate gratis
        </Link>
      </p>
    </motion.div>
