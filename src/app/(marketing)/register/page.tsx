...
function GoogleSignUpCard() {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-[0_1px_2px_rgba(0,0,0,0.04),0_8px_24px_-6px_rgba(0,0,0,0.08)] border border-warm-200/60 p-8 sm:p-10 w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="order-2 lg:order-1 space-y-8">
            ...
            <div className="space-y-3" data-aos="fade-up" data-aos-delay="200">
              <BenefitItem icon={<CheckIcon />} text="Guardá todos tus estudios en un solo lugar" />
              <BenefitItem icon={<CheckIcon />} text="Compará resultados anteriores para ver tu evolución" />
              <BenefitItem icon={<CheckIcon />} text="Creá perfiles familiares para gestionar juntos" />
              <BenefitItem icon={<CheckIcon />} text="Recibí alertas sobre valores fuera de rango" />
            </div>
