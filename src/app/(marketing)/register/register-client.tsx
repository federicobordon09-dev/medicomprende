  ...
  return (
    <div className="bg-accent brutal-border-2 brutal-shadow p-6 sm:p-8 w-full">
      ...
      <p className="text-sm text-ink/70 mb-6 leading-relaxed font-mono">
        Accedé a todas las herramientas con tu cuenta de Google.
      </p>
      <button
      ...
      <p className="text-xs text-ink/60 text-center mt-4 font-mono leading-relaxed">
        Al registrarte aceptás nuestros{" "}
        <Link href="/terminos" className="text-ink font-bold underline decoration-2">términos</Link> y{" "}
        <Link href="/privacidad" className="text-ink font-bold underline decoration-2">privacidad</Link>.
      </p>
    </div>
  );
}
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-5 gap-8 lg:gap-12 items-start">
          <div className="lg:col-span-3 space-y-6">
            <span className="brutal-tag">Gratis • Pro • Ilimitado</span>

            <h1 className="font-display font-bold text-[clamp(2.2rem,5vw,3.6rem)] leading-[1.05] text-ink uppercase">
              Tu informe médico,{" "}
              <span className="bg-ink text-accent px-2">en claro</span>
            </h1>
            <p className="text-[18px] md:text-[19px] text-ink/70 max-w-xl leading-[1.5]">
              Creá tu cuenta gratis y empezá a entender tus estudios con la ayuda de la IA.
              Sin tecnicismos, sin ansiedad.
            </p>
            ...
            <div className="flex flex-wrap gap-4 lg:gap-6 brutal-border-2 bg-white px-4 py-3">
              {[
                ...
                { value: "3/mes", label: "análisis" },
                { value: "$3.000", label: "plan Pro" },
              ].map((stat) => (
